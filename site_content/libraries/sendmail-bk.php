...
if(isset($_POST['email_form'])) {
	$email_to = "ing_arismendy@hotmail.com, lacanterasaladenegocios@gmail.com";
	...
	if(!$captcha){
	    echo '<h2>Valida que no eres un bot</h2>';
	    exit;
	}
	...
	if(intval($responseKeys["success"]) !== 1) {
		...
		<link rel="stylesheet" href="../../site_layout/normalize.css">
		<link rel="stylesheet" href="../../site_layout/css_main_min.css">
		<link rel="stylesheet" href="../../site_layout/site_slideshow_styles.css">
				...
				<div id="wrapper_footer" class="col-xs-12">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-4 div_ft logo_ft">
							<img src="../../img/logoc_ft.png" alt="Logo La Cantera">
						</div>
